...
return [
     ...
     */
    'title' => "TBuy API Документация",

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'Это API Документация для Tbuy магазина',
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'Вы можете получить свой токен, посетив свою панель управления и нажав <b>Создать токен API</b>.',
    ],
...
<aside>При прокрутке вы увидите примеры кода для работы с API на разных языках программирования в темной области справа (или как часть контента для мобильных устройств).
Вы можете переключить используемый язык с помощью вкладок в правом верхнем углу (или из навигационного меню в левом верхнем углу на мобильном устройстве).</aside>
INTRO
    ,
    ...
    'examples' => [
         ...
         * set this to any number (e.g. 1234)
         */
        'faker_seed' => null,
